...
FIND_PATH(HYPERTABLE_INCLUDE_DIR Hypertable/Lib/Client.h
	/usr/include
	/usr/local/include
	/usr/hypertable/0.9.8.9/include
	/usr/local/hypertable/0.9.8.9/include
	/opt/hypertable/0.9.8.9/include
)
...
FIND_FILE(HYPERTABLE_CONFIG_FILE conf/hypertable.cfg
	/usr/include
	/usr/local/include
	/usr/hypertable/0.9.8.9
	/usr/local/hypertable/0.9.8.9
	/opt/hypertable/0.9.8.9
)
...
set(HYPER_LIB_PATHS
		/usr/lib
		/usr/local/lib
		/usr/hypertable/0.9.8.9/lib
		/usr/local/hypertable/0.9.8.9/lib
		/opt/hypertable/0.9.8.9/lib
)
